...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-tattoodo-demo/CHTCollectionViewWaterfallLayout.framework"
  install_framework "Pods-tattoodo-demo/CSStickyHeaderFlowLayout.framework"
  install_framework "Pods-tattoodo-demo/DGActivityIndicatorView.framework"
  install_framework "Pods-tattoodo-demo/DGElasticPullToRefresh.framework"
  ...
  install_framework "Pods-tattoodo-demo/MMParallaxCell.framework"
